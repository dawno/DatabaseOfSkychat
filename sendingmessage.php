...
$query_sender = mysqli_query($con, "SELECT * FROM chatdata WHERE (sender_name = '$sender_name' OR sender_name = '$receiver_name') AND (receiver_name = '$receiver_name' OR receiver_name = '$sender_name') ORDER BY created_at ASC" );
